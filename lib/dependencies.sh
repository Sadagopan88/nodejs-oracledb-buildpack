install_oracle_libraries(){
  ...
  cd $build_dir/oracle
  local sdk_download_url="https://github.com/Sadagopan88/nodejs-oracledb-buildpack/raw/master/instantclient-sdk.zip"
  local basic_download_url="https://github.com/Sadagopan88/nodejs-oracledb-buildpack/raw/master/instantclient-basic.zip"
